...
export function CampaignCardCompact(props: CampaignCardCompactProps) {
    ...
    return (
        <article
            className={cn("md:flex flex flex-row w-full bg-white border border-[#e6e8eb] rounded-2xl p-5 items-center justify-between gap-4", className)}
        ...
        >
            <div className="flex flex-col md:flex-row md:items-center md:justify-between w-full gap-2">
                <div className="flex items-center gap-3 justify-center">
                    ...
                    <div>
                        <div className="flex font-semibold text-[#034d6b] truncate text-xl items-start">{title}</div>
