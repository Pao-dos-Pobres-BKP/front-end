...
type ModalVariant = 'logout' | 'whatsapp-redirect' | 'main-site-redirect' | 'newsletter-success' | 'newsletter-error';
...
const modalConfig = {
  logout: {
    ...
    description: 'Após realizar essa ação, você precisará fazer login novamente para acessar sua conta.',
    actions: [
  ...
  'whatsapp-redirect': {
    ...
    description: 'Você será redirecionado para uma conversa via WhatsApp com um de nossos atendentes. Deseja continuar?',
    actions: [
      { label: 'Voltar', variant: 'senary' as const, action: 'close' },
      { label: 'Continuar', variant: 'primary' as const, action: 'confirm' }
    ]
  ...
  'newsletter-success': {
    ...
    actions: [
      { label: 'Fechar', variant: 'senary' as const, action: 'close' }
    ]
  },
  'newsletter-error': {
