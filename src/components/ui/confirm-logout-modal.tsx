    ...
    <div className="fixed inset-0 backdrop-blur-sm bg-black/20 flex items-center justify-center z-50 px-2">
      <div className="bg-white w-full max-w-md rounded-xl p-6 shadow-lg mx-4 sm:mx-0">
        ...
        <div className="flex justify-end gap-4">
          <button className="px-6 py-2 text-black font-semibold cursor-pointer" onClick={onClose}>
            Cancelar
          </button>
          <button className="px-6 py-2 bg-[#026E98] text-white rounded-lg cursor-pointer" onClick={handleLogout}>
            Sair
          </button>
        </div>
      </div>
