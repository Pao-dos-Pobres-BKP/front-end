    ...
    <div className="w-full px-4 sm:px-8 py-10 flex flex-col gap-4 bg-gray-200">
      ...
      <Accordion type="single" collapsible className="w-full">
        <AccordionItem value="usuario" className="w-full">
            <AccordionTrigger size="large" variant="secondary" className="flex items-center gap-3 sm:p-2 min-h-[88px] sm:min-h-[56px] overflow-hidden">
              ...
              <div className="flex flex-col sm:flex-row sm:justify-between flex-1 min-w-0">
                ...
                <div className="flex flex-col justify-center mt-2 sm:mt-0">
                  ...
                  <Label className="text-[var(--color-text-special-2)] text-sm break-words">para Campanha Santo Antônio</Label>
                </div>
              </div>
            </AccordionTrigger>
          ...
          <AccordionContent variant="secondary" className="w-full bg-gray-200">
            ...
            <div className="flex flex-col sm:flex-row sm:gap-4 w-full">
              ...
              <div>
                <Label className="font-color-">Campanha de Santo Antônio</Label><br />
                <Label>Campanha de Aniversário de 130 anos do Pão</Label><br />
                <Label>Campanha de Natal Solidário</Label><br />
            ...
            <div className="flex w-full justify-end mt-4">
              <Popover>
                <PopoverTrigger asChild>
                  <Button variant="tertiary" size="small">Adicionar Dados</Button>
                </PopoverTrigger>
                <PopoverContent align="center" className="w-100 bg-white">
                  <div className="flex flex-col gap-3">
                    <span className="font-semibold">Adicione dados a um usuário</span>
                    <span>Adicione dados de doações realizadas por um usuário conforme seu comprovante de pagamento.</span>
                    <div className="justify-left flex items-center gap-2">
                      <Label>Valor:</Label>
                      <Input placeholder="R$ 00,00" />
                    </div>
                    <div className="flex flex-col sm:flex-row sm:gap-4 w-full gap-2">
                      <Button size="small" variant="tertiary">Cancelar</Button>
                      <Button size="small" variant="primary">Continuar</Button>
                    </div>
                  </div>
                </PopoverContent>
              </Popover>
